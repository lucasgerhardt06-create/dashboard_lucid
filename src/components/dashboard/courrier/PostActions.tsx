...
import { archiveCourrier, notifyCourrier, publishCourrier, replyCourrier, type ActionResult } from "@/app/actions/courrier";
...
export function PostActions({ post, preview, withBanner=true }:{ post:ActionablePost; preview:boolean; withBanner?:boolean }) {
  ...
  const busy = publishing||notifying||archiving;
  ...
  return <div className="grid gap-2">
    ...
    {withBanner && <ResultBanner state={latest(published,notified,archived)}/>}
  </div>;
}
